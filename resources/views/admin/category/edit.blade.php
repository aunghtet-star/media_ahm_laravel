...
@section('content')
    <div class="row ">
        <div class="col-4 my-4">
            <h3 class="text-center mb-2">Edit Category</h2>
                <form method="post" action="{{ route('admin#updateCategory', $category->id) }}">
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-11">
                            {{-- unique field for title is to be okay  --}}
                            <input type="hidden" name="category_id" value="{{ $category->id }}">
                            <input type="text" name="categoryTitle" value="{{ old('categoryTitle', $category->title) }}"
                    ...
                    <div class="row ">
                        <div class="col-sm-11 d-flex justify-content-end">
                            <button class="btn btn-primary px-4 mr-3" type="submit">Update</button>
                            <a href="{{ route('admin#category') }}"><button class="btn btn-success px-4"
                        ...
                        <tbody>
                            ...
                            @foreach ($categories as $c)
                                <tr>
                                    ...
                                    <td>{{ $c->created_at }}</td>
                                    <td class="d-flex">
                                        <a href="{{ route('admin#editCategory', $c->id) }}"><button
